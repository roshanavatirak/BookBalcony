...
//   RefreshCw, XCircle, Zap, TrendingDown, BarChart3
// } from "lucide-react";
...
//         axios.get("http://localhost:3000/api/v1/seller/dashboard-stats", { headers }),
//         axios.get("http://localhost:3000/api/v1/seller/orders?page=1&limit=5", { headers }),
//         axios.get("http://localhost:3000/api/v1/seller/myproducts", { headers }),
//         axios.get("http://localhost:3000/api/v1/seller/new-order-notifications", { headers })
//       ]);
...
//             {/* Total Products */}
//             <div className="bg-zinc-800/40 rounded-lg border border-zinc-700 p-4 hover:border-purple-400/50 transition-all group">
//               <div className="flex items-center justify-between mb-2">
...
//               </div>
//               <p className="text-2xl font-bold text-white mb-1">
//                 {topProducts.length + lowStockProducts.length}
//               </p>
//               <p className="text-xs text-purple-400 font-medium">In inventory</p>
//             </div>
//           </div>
//         )}
...
//                 <span className="text-zinc-400 text-xs font-semibold">Low Stock</span>
//               </div>
//               <p className="text-xl font-bold text-white">{lowStockProducts.length}</p>
//             </div>
//           </div>
//         )}
