...
function TrendingBooks() {
  ...
  useEffect(() => {
    const fetch = async () => {
      ...
      setData(response.data.data.slice(0, 10)); // top 10
    };
    fetch();
  }, []);
  ...
  return (
    <div className="bg-gradient-to-br from-gray-900 via-zinc-800 to-gray-900 py-10 px-4 sm:px-10 rounded-3xl mt-14 shadow-inner relative">
      ...
      <div className="text-center mb-10">
        ...
        <p className="text-sm text-yellow-300 italic mb-2">Top Picks Curated for You</p>
      ...
      {Data && (
        <div className="relative">
          ...
          <div
            ref={scrollRef}
            className="flex gap-6 overflow-x-auto pb-8 pr-6 pl-10 pt-6 scroll-smooth scrollbar-none"
            style={{
              scrollbarWidth: "none",
          ...
          >
            {Data.map((item, i) => (
              <div
                key={i}
                className="min-w-[250px] sm:min-w-[280px] md:min-w-[300px] relative group transition-transform duration-300 hover:scale-105"
              >
