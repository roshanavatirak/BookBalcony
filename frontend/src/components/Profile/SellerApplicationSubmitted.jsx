...
const SellerApplicationSubmitted = () => {
  ...
  return (
       ...
       <div className="bg-zinc-900/50 rounded-3xl min-h-screen px-8 py-10 shadow-xl border border-zinc-700 flex items-center justify-center p-6">
      <motion.div
...
export default SellerApplicationSubmitted;
