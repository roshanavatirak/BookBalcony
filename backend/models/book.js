...
const bookSchema = new mongoose.Schema(
  {
    ...
    seller: {
      ...
      ref: "user",
      required: [true, "Seller ID is required"]
      // ✅ REMOVED: index: true (will use schema.index below)
    },
    stock: { 
      type: Number, 
      default: 1,
...
// ✅ FIXED: Indexes for better query performance (no duplicates)
bookSchema.index({ seller: 1 });           // ✅ Keep this
bookSchema.index({ category: 1 });          // ✅ Keep this
